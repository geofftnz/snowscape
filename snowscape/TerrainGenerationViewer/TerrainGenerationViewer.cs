...
namespace Snowscape.TerrainGenerationViewer
{
    public class TerrainGenerationViewer : GameWindow
    {
            ...
            : base(800, 600, new GraphicsMode(new ColorFormat(8, 8, 8, 8), 24, 8), "Snowscape", GameWindowFlags.Default, DisplayDevice.Default, 3, 1, GraphicsContextFlags.Default)
        {
            ...
            parameters.Add(new Parameter<float>("sunAzimuth", 0.2f, 0.0f, 1.0f, v => v + 0.002f, v => v - 0.002f, ParameterImpact.PreCalcLighting));
            ...
            parameters.Add(new Parameter<float>("skyPrecalcBoundary", 0.0f, 0.0f, 128.0f, v => v * 1.02f, v => v * 0.98f, ParameterImpact.PreCalcLighting));

            parameters.Add(new Parameter<float>("mieBrightness", 2.0f, 0.0001f, 1000.0f, v => v * 1.02f, v => v * 0.98f, ParameterImpact.PreCalcLighting));
            parameters.Add(new Parameter<float>("miePhase", 0.97f, 0.0f, 1.0f, v => v + 0.001f, v => v - 0.001f, ParameterImpact.PreCalcLighting));
            parameters.Add(new Parameter<float>("raleighBrightness", 40.0f, 0.0001f, 1000.0f, v => v * 1.02f, v => v * 0.98f, ParameterImpact.PreCalcLighting));


            parameters.Add(new Parameter<float>("skylightBrightness", 4.0f, 0.0001f, 40.0f, v => v * 1.02f, v => v * 0.98f));
            ...
            parameters.Add(new Parameter<float>("NearScatterDistance", 2500.0f, 10.0f, 20000.0f, v => v + 10f, v => v - 10f));
        ...
        private void RenderGBufferCombiner()
        {
            ...
            var rp = new Lighting.LightingCombiner.RenderParams()
            {
                ...
                SkylightTextureSmooth = this.skylightRenderer.SkylightTexture,
                SkylightTextureSharp = this.skylightRenderer.SkylightTexture2,
                EyePos = this.eyePos,
                ...
                SunLight = new Vector3(this.parameters["Sun_r"].GetValue<float>(), this.parameters["Sun_g"].GetValue<float>(), this.parameters["Sun_b"].GetValue<float>()) * this.parameters["Sun_Brightness"].GetValue<float>(),
