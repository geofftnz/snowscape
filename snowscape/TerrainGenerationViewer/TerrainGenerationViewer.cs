    ...
    public class TerrainGenerationViewer : GameWindow
    {
        ...
        protected void UpdateShadeTexture()
        {
            ...
            ParallelHelper.For2D(TileWidth, TileHeight, (i) =>
            {
                ...
                this.shadeTexData[j] = (byte)((this.threadRenderMap[i].Clay * 16.0f).Clamp(0.0f, 255.0f));
                this.shadeTexData[j + 1] = (byte)((this.threadRenderMap[i].Silt * 64.0f).Clamp(0.0f, 255.0f));
                this.shadeTexData[j + 2] = (byte)((this.threadRenderMap[i].MovingWater * 2048.0f).Clamp(0.0f, 255.0f));
                ...
                this.shadeTexData[j + 3] = (byte)((this.threadRenderMap[i].VisParam * 0.25f).Clamp(0.0f, 255.0f)); // misc - age
            });
