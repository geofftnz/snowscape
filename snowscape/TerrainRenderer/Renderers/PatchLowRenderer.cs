...
namespace Snowscape.TerrainRenderer.Renderers
{
    ...
    /// </summary>
    public class PatchLowRenderer : GameComponentBase, ITileRenderer, IPatchRenderer, IReloadable
    {
        ...
        public PatchLowRenderer(int width, int height, IPatchCache patchCache)
            : base()
        {
            if (width != height)
            {
